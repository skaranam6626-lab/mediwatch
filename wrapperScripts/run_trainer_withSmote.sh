...
export MODEL_FILE=$HOME_PATH"/output/mediwatch_withSmote.joblib"
export EXPERIMENT_NAME="MediWatch-PatientReadmission-withSmote-1"
export N_ESTIMATORS=10
export MAX_DEPTH=10
export TRAINED_DATA_FILE=$HOME_PATH"/output/trainingData_withSmote.csv"

#Run mlflow in background (use python -m; Airflow task PATH may omit ~/.local/bin)
python3 pythonScripts/trainer_withSmote.py
